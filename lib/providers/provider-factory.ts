...
import { ProviderId, PROVIDERS, PROVIDER_CAPABILITIES } from "@/lib/types/provider-types";
...
import { isProviderConfigured, getDefaultModelForProvider } from "@/stores/useAIStore";
...
export function getProviderModel(providerId: ProviderId, modelId?: string): ProviderResult {
    ...
    console.log(`getProviderModel called with providerId: ${providerId}, modelId: ${model}`);
    ...
    switch (providerId) {
        ...
        case "openai":
            ...
            console.log("OpenAI model result:", openaiModel ? "created" : "null");
            return {
                model: openaiModel,
        ...
        case "openrouter":
            ...
            console.log("OpenRouter model result:", openrouterModel ? "created" : "null");
            return {
        ...
        case "ollama":
            ...
            console.log("Ollama model result:", ollamaModel ? "created" : "null");
            return {
                model: ollamaModel,
